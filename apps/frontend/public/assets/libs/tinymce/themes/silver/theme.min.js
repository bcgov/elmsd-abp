...
!(function () {
  ...
  const an = (e, t, o) => (e.stype === rn.Error ? t(e.serror) : o(e.svalue)),
    ...
    Tn = (e, t, o, n, s) => {
      ...
      switch (e.tag) {
        case "required":
          return ((e, t, o, n) =>
            be(t, o).fold(() => ((e, t, o) => kn(e, () => 'Could not find valid *required* value for "' + t + '" in ' + Sn(o)))(e, o, t), n))(
            t,
            o,
            n,
            r
    ...
    qn = (e, t, o) => {
      return (
        (n = ((e, t, o) =>
          ((e, t) => (e.stype === rn.Error ? { stype: rn.Error, serror: t(e.serror) } : e))(t.extract([e], o), (e) => ({ input: o, errors: e })))(
          e,
          t,
          o
        )),
                  ...
                  write: () => {
                    ...
                    R(["mousemove", "mouseover", "mouseout", br()], e) ||
                      console.log(e, {
                        ...
                        target: t.dom,
                        sequence: H(o, (e) =>
                          R(["cut", "stopped", "response"], e.outcome) ? "{" + e.purpose + "} " + e.outcome + " at (" + na(e.target) + ")" : e.outcome
                        )
                      })
                  }
                }
  ...
  const _g = (e) => (t, o, n, s) => {
    ...
    Xg = x([
      ...
      dg(ag([ig, rg(qm)]), Wg),
      dg(ag([cg, rg(qm)]), Wg),
      dg(rg(Km.concat(Xm)), (e, t, o, n) => ((e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)))(e, o).bind((n) => o.execute(e, t, n)))
    ]),
  ...
  const uh = () => {
    ...
    Ch = x("item-widget"),
    Oh = x([
      Uu({ name: "widget", overrides: (e) => ({ behaviours: kl([pu.config({ store: { mode: "manual", getValue: (t) => e.data, setValue: b } })]) }) })
    ]),
    _h = [
      os("uid"),
      os("data"),
    ...
    Ah = x([
      ...
      xs(
        ...
        Jn("mode", {
          ...
          menu: [
            ys("moveOnTab", !0),
            Ri("config", (e, t) => ({ mode: "menu", selector: "." + e.markers.item, moveOnTab: t.moveOnTab, focusManager: e.focusManager }))
          ]
        })
      ),
      ns("markers", _i()),
        ...
        const t = jh({ dom: { tag: "p", innerHtml: e.translationProvider(e.text) }, behaviours: kl([Kp.config({})]) }),
          ...
          i = jh(
            Wh.sketch({
              ...
              components: [
                ef("close", { tag: "span", classes: ["tox-icon"], attributes: { "aria-label": e.translationProvider("Close") } }, e.iconProvider)
              ],
              action: (t) => {
                e.onAction(t)
              }
  ...
  const hb = "tox-menu-nav__js",
    ...
    Ab = (e) => {
      const t = Eb(e)
      return { backgroundMenu: t.backgroundMenu, selectedMenu: t.selectedMenu, menu: t.menu, selectedItem: t.selectedItem, item: _b(e) }
    },
    Mb = (e, t, o) => {
      const n = Eb(o)
    ...
    Ub = Pb,
    Wb = (e) => ({ fetchPattern: pu.getValue(e), selectionStart: e.element.dom.selectionStart, selectionEnd: e.element.dom.selectionEnd }),
    jb = (e) => {
    ...
    Yb = (e, t, o) =>
      Dh.parts.items({
        preprocess: (n) => {
          const s = H(n, o)
          return "auto" !== e && e > 1 ? qb({ tag: "div", classes: ["tox-collection__group"] }, e)(s) : Xb(s, (e, o) => "separator" === t[o].type)
        }
      }),
    Kb = (e, t, o = !0) => ({
          ...
          components: [
            {
              ...
              components: [Dh.parts.items({ preprocess: "auto" !== e ? qb({ tag: "div", classes: ["tox-swatches__row"] }, e) : w })]
            }
          ]
        }))(n)
            ...
            ? ((e, t, o) => {
                ...
                return {
                  ...
                  components: [
                    ...
                    {
                      dom: { tag: "div", classes: [...(1 === e ? ["tox-collection--list"] : ["tox-collection--grid"]), Gb], attributes: { id: n } },
                      components: [Yb(e, t, $b)]
                    }
                  ]
                }
  ...
  const kx = {},
    ...
    Bx = (e) => {
      const t = []
      for (let o = 0; o < e.length; o += 2) t.push({ text: e[o + 1], value: "#" + Ax(e[o]).value, icon: "checkmark", type: "choiceitem" })
      return t
    },
    ...
    Gx = (e, t, o) => e.concat(((e) => H(Cx(e).state(), (e) => ({ type: "choiceitem", text: e, icon: "checkmark", value: e })))(t).concat(Wx(o))),
    $x = (e, t, o) => (n) => {
      n(Gx(e, t, o))
    },
    qx = (e, t, o) => {
    ...
    aw = {
      inserttable: (e, t) => {
        const o = (
          ...
          s = rw(0, 0),
          r = jh({ dom: { tag: "span", classes: ["tox-insert-table-picker__label"] }, components: [s], behaviours: kl([Kp.config({})]) })
        return {
          type: "widget",
    ...
    iw = (e) => ({ type: "separator", dom: { tag: "div", classes: [fb, "tox-collection__group-heading"] }, components: e.text.map(ti).toArray() })
  ...
  const Nw = (e, t, o, n, s) => {
          ...
          switch (e.type) {
            ...
            case "cardmenuitem":
              return ((e) => qn("cardmenuitem", Zv, e))(e).fold(Zb, (e) =>
                A.some(
                  ((e, t, o, n) => {
                    const s = { dom: Py(e.label), optComponents: [A.some({ dom: { tag: "div", classes: [Cb, Ob] }, components: Gy(e.items, n) })] }
                    return By(
                      {
      ...
      const o = { stopBackspace: !0, ...t },
        ...
        i = tc(e, "keydown", (e) => {
          o.triggerEvent("keydown", e)
            ? e.kill()
            : o.stopBackspace &&
              ((e) => e.raw.which === $m[0] && !R(["input", "textarea"], Ue(e.target)) && !$w(e.target, '[contenteditable="true"]'))(e) &&
              e.prevent()
        }),
        l = tc(e, "focusin", (e) => {
    ...
    nS = (e) => {
      const t = (t) => st(e.element).fold(E, (e) => Ze(t, e)),
        o = tS(),
        n = (e, n) => o.find(t, e, n),
        s = Yw(e.element, { triggerEvent: (e, t) => Si(e, t.target, (o) => ((e, t, o, n) => eS(e, t, o, o.target, n))(n, e, t, o)) }),
        r = {
          debugInfo: x("real"),
          triggerEvent: (e, t, o) => {
  ...
  const fC = bm({
          ...
          factory: () => {
            ...
            return fn(
              CC.sketch((o) => ({
                ...
                formBehaviours: kl([FS.config({ invalidClass: t("form-invalid") }), Jp("rgb-form-events", [Ur(OC, g), Ur(_C, m), Ur(TC, m)])])
              })),
              {
                apis: {
                  updateHex: (e, t) => {
      ...
      const o = fm({
        ...
        factory: (o) => {
          const n = AC(e, t, o.onValidHex, o.onInvalidHex),
            s = ((e, t) => {
              const o = fC.parts.spectrum({ dom: { tag: "canvas", attributes: { role: "presentation" }, classes: [t("sv-palette-spectrum")] } }),
                n = fC.parts.thumb({
                  dom: {
                    tag: "div",
            ...
            a = jh(
              ((e, t) => {
                const o = fC.parts.spectrum({ dom: { tag: "div", classes: [t("hue-slider-spectrum")], attributes: { role: "presentation" } } }),
                  n = fC.parts.thumb({ dom: { tag: "div", classes: [t("hue-slider-thumb")], attributes: { role: "presentation" } } })
                return fC.sketch({
    ...
    RC = (e, t, o) => pu.config({ store: { mode: "manual", ...e.map((e) => ({ initialValue: e })).getOr({}), getValue: t, setValue: o } }),
    NC = (e, t, o) =>
      RC(
        e,
        (e) => t(e.element),
  ...
  const PC = (e, t) => {
    ...
    GC = (e, t) => ({ dom: { tag: "div", classes: ["tox-navobj", ...e.getOr([])] }, components: [jC([UC]), t, jC([WC])], behaviours: kl([BC(1)]) }),
    $C = (e, t) => {
    ...
    lO = (e, t, o) => {
      ...
      A.from(n.contentDocument).fold(o, (e) => {
        ...
        const s = ((e, t) => {
            const o = e.body
            return A.from(
              !/^<!DOCTYPE (html|HTML)/.test(t) && ((!rO && !oO) || (g(o) && (0 !== o.scrollTop || Math.abs(o.scrollHeight - o.clientHeight) > 1)))
                ? o
                : e.documentElement
            )
          })(e, t)
    ...
    bO = (e, t, o) => ({ dom: { tag: "span", classes: [`${t}__select-label`] }, components: [ti(o.translate(e))], behaviours: kl([Kp.config({})]) }),
    ...
    BO = x([
      ...
      Uu({
        ...
        schema: [os("dom")],
        name: "lock",
        overrides: (e) => ({ buttonBehaviours: kl([dh.config({ selected: e.locked, toggleClass: e.markers.lockClass, aria: { mode: "pressed" } })]) })
      })
    ]),
    FO = bm({
  ...
  const QO = Ol({
    ...
    n_ = (e) => ({ dom: { tag: "span", classes: ["tox-tree__label"], attributes: { title: e, "aria-label": e } }, components: [ti(e)] }),
                ...
                c =
                  ...
                  i.map((e) =>
                    "leaf" === e.type
                      ...
                      : d_({ directory: e, expandedIds: l.get(), selectedId: a, onLeafAction: t, labelTabstopping: d, treeId: n, backstage: s })
                  ))
              var d
  ...
  const f_ = Ol({ fields: h_, name: "streaming", active: m_, state: p_ }),
    ...
    __ = (e, t, o = [], n, s, r) => {
      const a = t.fold(
        ...
        i = {
          buttonBehaviours: kl(
            [ky(() => !e.enabled || r.isDisabled()), Sy(), cS.config({}), Jp("button press", [Pr("click"), Pr("mousedown")])].concat(o)
          ),
    ...
    B_ = (e, t, o) => {
      if (((e, t) => "menu" === t)(0, t)) {
        const t = () => r,
          n = e,
          s = { ...e, type: "menubutton", search: A.none(), onSetup: (t) => (t.setEnabled(e.enabled), b), fetch: o_(n.items, t, o) },
    ...
    $_ = {
      bar: G_((e, t) =>
        ((e, t) => ({ dom: { tag: "div", classes: ["tox-bar", "tox-form__controls-h-stack"] }, components: H(e.items, t.interpreter) }))(e, t.shared)
      ),
      collection: G_((e, t, o) =>
        ((e, t, o) => {
                  ...
                  onSetValue: (o, n) => {
                    ;((o, n) => {
                      const s = H(n, (o) => {
                          ...
                          }" tabindex="-1" data-collection-item-value="${dS.encodeAllRaw(o.value)}" title="${i}" aria-label="${i}">${r}${s}</div>`
                        }),
      ...
      grid: G_((e, t) =>
        ((e, t) => ({ dom: { tag: "div", classes: ["tox-form__grid", `tox-form__grid--${e.columns}col`] }, components: H(e.items, t.interpreter) }))(
          e,
          t.shared
        )
      ),
        ...
        ((e, t, o, n) => {
                      ...
                      (t) => {
                        ...
                        return "file" === e
                          ? ((s = [n, P_(a, V_(t)), P_(a, q([H_(t), z_(t), L_(t)]))]),
                            j(s, (e, t) => (0 === e.length || 0 === t.length ? e.concat(t) : e.concat(F_, t)), []))
                          : n
                        var s
                      }
                    )
          ...
          return aS.sketch({
            ...
            components: l
              .toArray()
              .concat([
                { dom: { tag: "div", classes: ["tox-form__controls-h-stack"] }, components: q([[g.asSpec()], u.map(() => p.asSpec()).toArray()]) }
              ]),
            fieldBehaviours: kl([
              Rm.config({
            ...
            l = (n, s) =>
              e.items.map((e) =>
                "leaf" === e.type
                  ...
                  : d_({ directory: e, selectedId: n, onLeafAction: o, expandedIds: s, labelTabstopping: !0, treeId: i, backstage: t })
              )
          return {
      ...
      panel: G_((e, t) => ((e, t) => ({ dom: { tag: "div", classes: e.classes }, components: H(e.items, t.shared.interpreter) }))(e, t))
    },
    ...
    vT = (e, t, o, n) => {
      ...
      return () =>
        n()
          ...
          : { type: "hotspot", hotspot: o(), bubble: gc(0, 0, fT), layouts: { onRtl: () => [ll], onLtr: () => [ll] }, overrides: s }
    },
    yT = (e, t, o) => () =>
      o()
    ...
    ST = (e, t, o, n) => {
      const s = sb(e),
        ...
        i = () => s || !n()
      return { inlineDialog: bT(a, t, i), inlineBottomDialog: vT(e.inline, a, o, i), banner: yT(a, t, i), cursor: xT(e, r), node: wT(r) }
    },
    kT = (e) => (t, o) => {
      Jx(e)(t, o)
    },
    ...
    rE = (e) => ({
      getHistory: QT,
      addToHistory: eE,
      getLinkInformation: () => ((e) => (Vf(e) ? A.some({ targets: XT(e.getBody()), anchorTop: sE(zf(e)), anchorBottom: sE(Hf(e)) }) : A.none()))(e),
    ...
    jE = Object.freeze({
      ...
      events: (e, t) =>
        Hr([
          Yr(or(), (o, n) => {
            e.contextual.each((e) => {
              Ua(o.element, e.transitionClass) && (ja(o.element, [e.transitionClass, e.fadeInClass]), (t.isVisible() ? e.onShown : e.onHidden)(o)),
                n.stop()
            })
          }),
          Ur(xr(), (o, n) => {
        ...
        $E.config({
          ...
          lazyViewport: (t) =>
            jw(e, t.element).fold(
              ...
              (e) => ({ bounds: Gw(e), optScrollEnv: A.some({ currentScrollTop: e.element.dom.scrollTop, scrollElmTop: Xt(e.element).top }) })
            ),
  ...
  const cA = "container",
    ...
    xA = (e) =>
      wm
        .getCurrent(e)
        .bind((e) => (QO.isGrowing(e) || QO.hasGrown(e) ? wm.getCurrent(e).bind((e) => G(pA.getSlotNames(e), (t) => pA.isShowing(e, t))) : A.none())),
    wA = la("FixSizeEvent"),
    SA = la("AutoSizeEvent")
  ...
  const OA = Ol({
    ...
    HA = x([
      ...
      Wu({
        ...
        schema: mE(),
        name: "toolbar",
        overrides: (e) => ({ toolbarBehaviours: kl([Pp.config({ mode: "cyclic", onEscape: (t) => (om(t, e, "button").each(oh.focus), A.none()) })]) })
      })
    ]),
    LA = Ql(),
    PA = (e, t) => {
    ...
    UA = (e, t, o, n) => {
      ...
      Sd.positionWithinBounds(r, t, { anchor: { type: "hotspot", hotspot: e, layouts: n, overrides: { maxWidthFunction: VA() } } }, s)
    },
    WA = (e, t, o, n, s) => {
    ...
    ZA = x([
      ...
      Wu({
        ...
        overrides: (e) => ({
          buttonBehaviours: kl([dh.config({ toggleClass: e.markers.overflowToggledClass, aria: { mode: "pressed" }, toggleOnExecute: !1 })])
        })
      }),
      Wu({ name: "overflow-group" })
    ]),
  ...
  var vM = bm({
        ...
        factory: {
          sketch: (e) => {
            ...
            const o = H(e.buttons, (o) =>
              "group" === o.type
                ? ((t = !0),
                  ((e, t) => ({ dom: { tag: "div", classes: ["tox-view__toolbar__group"] }, components: H(e.buttons, (e) => pM(e, t)) }))(
                    o,
                    e.providers
                  ))
                : pM(o, e.providers)
    ...
    factory: (e, t, o, n) => {
      const s = { getPane: (t) => aE.getPart(t, e, "pane"), getOnShow: (t) => e.viewConfig.onShow, getOnHide: (t) => e.viewConfig.onHide }
      ...
      pe(t, (t, n) => {
        ...
        return e.slot(
          ...
          vM.sketch({
            ...
            viewConfig: s,
            components: [...(s.buttons.length > 0 ? [vM.parts.header({ buttons: s.buttons, providers: o })] : []), vM.parts.pane({})]
          })
        )
      }),
    xM = (e, t) =>
      ...
      const n = (e, n, r, a) => {
          ...
          if ("submenu" === e.type) {
            ...
            return 0 === n && t.length <= 0
              ? A.none()
              : A.some({ type: "nestedmenuitem", text: i, enabled: t.length > 0, getSubmenuItems: () => X(e.getStyleItems(), (e) => s(e, n, a)) })
          }
          return A.some({
            type: "togglemenuitem",
            text: i,
  ...
  const YM = (e, t, o) => {
    ...
    CD = (e, t, o) => kD(e, { toolbarButtonBehaviours: o.length > 0 ? [Jp("toolbarButtonWith", o)] : [], getApi: vD, onSetup: e.onSetup }, t),
    OD = (e, t, o) =>
      kD(
        e,
        {
      ...
      splitbutton: ED(
        ...
        (e, t) =>
          ((e, t) => {
            ...
            return bD.sketch({
              dom: { tag: "div", classes: ["tox-split-button"], attributes: { "aria-pressed": !1, ...xD(e.tooltip, t.providers) } },
              onExecute: (t) => {
                const n = o(t)
              ...
              components: [
                bD.parts.button(
                  SD(e.icon, e.text, A.none(), A.some([dh.config({ toggleClass: "tox-tbtn--enabled", toggleOnExecute: !1 })]), t.providers)
                ),
                bD.parts.arrow({
  ...
  const GD = "contexttoolbar-hide",
            ...
            i = q(
              H(t, (t) =>
                "contexttoolbar" === t.type
                  ? ((t, o) => DD(e, { buttons: t, toolbar: o.items, allowToolbarGroups: !1 }, n.backstage, A.some(["form:"])))(s, t)
                  : ((e, t) => qD(e, t))(t, r.providers)
              )
            )
          return lM({ type: a, uid: la("context-toolbar"), initGroups: i, onEscape: A.none, cyclicKeying: !0, providers: r.providers })
        },
        x = (t, n) => {
      ...
      ;((e) => {
        ;((e) => {
          LC.each(
            ...
            (t, o) => {
              e.ui.registry.addToggleButton(t.name, { tooltip: t.text, icon: t.icon, onSetup: vx(e, t.name), onAction: pB(e, t.name) })
            }
          )
          for (let t = 1; t <= 6; t++) {
            const o = "h" + t
            e.ui.registry.addToggleButton(o, { text: o.toUpperCase(), tooltip: "Heading " + t, onSetup: vx(e, o), onAction: pB(e, o) })
          }
        })(e),
          ((e) => {
            LC.each(
              ...
              LC.each(
                ...
                (t) => {
                  e.ui.registry.addButton(t.name, { tooltip: t.text, icon: t.icon, onSetup: bx(e), onAction: wx(e, t.action) })
                }
              )
          })(e),
          ((e) => {
            LC.each([{ name: "blockquote", text: "Blockquote", action: "mceBlockQuote", icon: "quote" }], (t) => {
              e.ui.registry.addToggleButton(t.name, { tooltip: t.text, icon: t.icon, onAction: wx(e, t.action), onSetup: vx(e, t.name) })
            })
          })(e)
      })(e),
        ((e) => {
          LC.each(
            ...
            (t) => {
              e.ui.registry.addMenuItem(t.name, { text: t.text, icon: t.icon, shortcut: t.shortcut, onAction: wx(e, t.action) })
            }
          ),
            LC.each(
              [
              ...
              (t) => {
                e.ui.registry.addMenuItem(t.name, { text: t.text, icon: t.icon, shortcut: t.shortcut, onSetup: bx(e), onAction: wx(e, t.action) })
              }
            ),
            e.ui.registry.addMenuItem("codeformat", { text: "Code", icon: "sourcecode", onSetup: bx(e), onAction: pB(e, "code") })
        })(e)
    },
    fB = (e, t) =>
    ...
    vB = (e, t) => {
      ;((e) => {
        L(
          ...
          (t) => {
            e.ui.registry.addToggleButton(t.name, { tooltip: t.text, icon: t.icon, onAction: wx(e, t.cmd), onSetup: vx(e, t.name) })
          }
        ),
          e.ui.registry.addButton("alignnone", { tooltip: "No alignment", icon: "align-none", onSetup: bx(e), onAction: wx(e, "JustifyNone") })
      })(e),
        hB(e),
        ((e, t) => {
          ;((e, t) => {
        ...
        ((e) => {
          ;((e) => {
            e.ui.registry.addMenuItem("undo", { text: "Undo", icon: "undo", shortcut: "Meta+Z", onSetup: fB(e, "hasUndo"), onAction: wx(e, "undo") }),
            ...
            ((e) => {
              e.ui.registry.addButton("undo", { tooltip: "Undo", icon: "undo", enabled: !1, onSetup: fB(e, "hasUndo"), onAction: wx(e, "undo") }),
                e.ui.registry.addButton("redo", { tooltip: "Redo", icon: "redo", enabled: !1, onSetup: fB(e, "hasRedo"), onAction: wx(e, "redo") })
            })(e)
        })(e),
        ((e) => {
          ;((e) => {
        ...
        ((e) => {
          ;((e) => {
            e.ui.registry.addButton("visualaid", { tooltip: "Visual aids", text: "Visual aids", onAction: wx(e, "mceToggleVisualAid") })
          })(e),
            ((e) => {
              e.ui.registry.addToggleMenuItem("visualaid", { text: "Visual aids", onSetup: bB(e), onAction: wx(e, "mceToggleVisualAid") })
            })(e)
        })(e),
        ((e) => {
          ;((e) => {
            e.ui.registry.addButton("outdent", { tooltip: "Decrease indent", icon: "outdent", onSetup: mB(e), onAction: wx(e, "outdent") }),
              e.ui.registry.addButton("indent", { tooltip: "Increase indent", icon: "indent", onSetup: bx(e), onAction: wx(e, "indent") })
          })(e)
        })(e),
        uB(e),
        ((e) => {
          ...
          e.ui.registry.addToggleButton("pastetext", { active: !1, icon: "paste-text", tooltip: "Paste as text", onAction: o, onSetup: gB(e, t) }),
            e.ui.registry.addToggleMenuItem("pastetext", { text: "Paste as text", icon: "paste-text", onAction: o, onSetup: gB(e, t) })
        })(e)
    },
    yB = (e) => (r(e) ? e.split(/[ ,]/) : e),
    ...
    MB = { onLtr: () => [cl, sl, rl, al, il, ll, lT, cT, iT, rT, aT, sT], onRtl: () => [cl, rl, sl, il, al, ll, lT, cT, aT, sT, iT, rT] },
    DB = {
      valignCentre: [],
      alignCentre: [],
      alignLeft: ["tox-pop--align-left"],
      ...
      const a = Do(),
        ...
        u = () => {
          ...
          ;((e, t, o, n, s, r, a) => {
            const i = ((e, t, o) => {
              const n = EB(e, t, o)
              return { bubble: gc(0, "point" === o ? 12 : 0, DB), layouts: MB, overrides: { maxWidthFunction: VA(), maxHeightFunction: cc() }, ...n }
            })(e, t, r)
            CO(o, pb.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !0, search: A.none() }).map((o) => {
              t.preventDefault()
              const l = a ? zh.HighlightMenuAndItem : zh.HighlightNone
              Ph.showMenuWithinBounds(s, { anchor: i }, { menu: { markers: Ab("normal"), highlightOnOpen: l }, data: o, type: "horizontal" }, () =>
  ...
  const cF = [
    ...
    dF = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(((e, t, o) => ("fixed" === o ? JB : YB)(parseInt(e, 10), parseInt(t, 10)))(t.getOrDie(), o.getOrDie(), n.getOrDie()))
        : A.none()).getOrThunk(() => {
        const t = Xt(e)
  ...
  var hF = Object.freeze({ __proto__: null, getData: (e) => A.from($t(e.x, e.y)), getDelta: (e, t) => $t(t.left - e.left, t.top - e.top) })
  const fF = (e, t, o) => [
      Ur(Ws(), (n, s) => {
    ...
    _F = (e, t, o, n, s, r) =>
      e.fold(
        ...
        (e) => {
          ...
          return OF.snap({ sensor: KB(s, r), range: $t(40, 40), output: KB(A.some(o - a.width / 2), A.some(n - a.height / 2)), extra: { td: t } })
        }
      ),
    TF = (e, t, o) => ({
      getSnapPoints: e,
  ...
  const BF = (e, t, o) => {
        ...
        return (
          ...
          n &&
            o.push(
              (() => {
                const e = Iy("Alt+0")
                return { dom: { tag: "div", classes: ["tox-statusbar__help-text"] }, components: [ti(Gh.translate(["Press {0} for help", e]))] }
              })()
            ),
          r &&
            o.push(
              ...
              return A.some(
                ef(
                  "resize-handle",
                  {
                    ...
                    behaviours: [
                      OF.config({ mode: "mouse", repositionTarget: !1, onDrag: (t, n, s) => BF(e, s, o), blockerClass: "tox-blocker" }),
                      Pp.config({
                        mode: "special",
                        onLeft: () => FF(e, o, -1, 0),
                        onRight: () => FF(e, o, 1, 0),
    ...
    SR = (e) => {
      var t
      return { internalDialog: Xn(qn("dialog", hR, e)), dataValidator: wR(e), initialData: null !== (t = e.initialData) && void 0 !== t ? t : {} }
    },
    kR = {
      open: (e, t) => {
        const o = SR(t)
  ...
  const TR = Ol({
    ...
    AR = (e, t, o) => {
      const n = jh(
        CC.sketch((n) => ({ dom: { tag: "div", classes: ["tox-form"].concat(e.classes) }, components: H(e.items, (e) => X_(n, e, t, o)) }))
      )
      return {
      ...
      (function (e, t) {
        if (e) {
          ...
          return (
            ...
            "Map" === o || "Set" === o ? Array.from(e) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? ZR(e, t) : void 0
          )
        }
      })(e) ||
      (function () {
        ...
        Re = function (e, t, o) {
          ...
          if (X && !$[t] && yN(R, t));
            ...
            if (
              !(
                (Ne(e) &&
                  ((j.tagNameCheck instanceof RegExp && yN(j.tagNameCheck, e)) || (j.tagNameCheck instanceof Function && j.tagNameCheck(e))) &&
                ...
                ("is" === t &&
                  ...
                  ((j.tagNameCheck instanceof RegExp && yN(j.tagNameCheck, o)) || (j.tagNameCheck instanceof Function && j.tagNameCheck(o))))
              )
            )
              return !1
          } else if (ue[t]);
      ...
      return (
        (o.sanitize = function (e, s) {
          ...
          if ((Z || Se(s), (o.removed = []), "string" == typeof e && (re = !1), re)) {
            ...
            (1 === (l = (a = Me("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === l.nodeName) || "HTML" === l.nodeName
              ? (a = l)
              : a.appendChild(l)
          else {
  ...
  const $N = (e) => GN().sanitize(e),
    ...
    JN = (e, t) =>
      LF.parts.body({
        dom: { tag: "div", classes: ["tox-dialog__body"] },
        components: [{ dom: { tag: "div", classes: ["tox-dialog__body-content"] }, components: [{ dom: _A(`<p>${$N(t.translate(e))}</p>`) }] }]
      }),
    ...
    eV = (e) => {
      ...
      return LF.sketch({
        ...
        parts: { blocker: { dom: _A(`<div class="${o}"></div>`), components: [{ dom: { tag: "div", classes: qN ? [n, n + "--opaque"] : [n] } }] } },
        dragBlockClass: o,
        modalBehaviours: kl([
          oh.config({}),
          Jp(
    ...
    iV = (e, t, o, n) =>
      ri(
        eV({
          ...
          extraBehaviours: [TR.config({ channel: `${YC}-${e.id}`, updateState: (e, t) => A.some(t), initialData: t }), VC({}), ...e.extraBehaviours],
          onEscape: (e) => {
            Fr(e, bS)
          },
          dialogEvents: o,
    ...
    mV = (e, t) => {
      const o = t.map((e) => e.footerButtons).getOr([]),
        ...
        s = (e, t) => oS.sketch({ dom: { tag: "div", classes: [`tox-dialog__footer-${e}`] }, components: H(t, (e) => e.memento.asSpec()) })
            ...
            components: [
              {
                ...
                components: [GC(A.none(), { dom: { tag: "iframe", attributes: { src: e.url } }, behaviours: kl([cS.config({}), oh.config({})]) })]
              }
            ],
          ...
          return {
            open: (o, n) => {
              const s = (e) => {
                ...
                r = jh(
                  B_({ name: "yes", text: "Yes", primary: !0, buttonType: A.some("primary"), align: "end", enabled: !0, icon: A.none() }, "submit", e)
                ),
                a = B_(
