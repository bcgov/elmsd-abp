...
!(function () {
  ...
  const bs = (e, t = !0) =>
    ...
    Cs = (e, t) =>
      C(t.querySelector(e))
        ? (t.setAttribute(vs, "true"), "inline-boundary" === t.getAttribute("data-mce-selected") && t.removeAttribute("data-mce-selected"), !0)
    ...
    Qs = (e, t) =>
      e.replace(t ? js : Hs, (e) =>
        e.length > 1 ? "&#" + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ";" : Ws[e] || "&#" + e.charCodeAt(0) + ";"
      ),
    Js = (e, t, n) => {
      const o = n || Ys
    ...
    Du = (e, t, n) =>
      ((e, t, n = !1) =>
        2 === t
          ...
          ? ((e) => {
              const t = e.getRng()
              return { start: qi(e.dom.getRoot(), Li.fromRangeStart(t)), end: qi(e.dom.getRoot(), Li.fromRangeEnd(t)), forward: e.isForward() }
            })(e)
          : t
          ...
          "raw" === t.format
            ...
            ? ((e, t) => {
                const n = e.getDoc(),
                  o = Vn(yn(e.getBody())),
                  r = bn("div", n)
                Jt(r, "data-mce-bogus", "all"), io(r, { position: "fixed", left: "-9999999px", top: "0" }), So(r, t.innerHTML), $g(r), Vg(r)
  ...
  const Xg = ["font", "text-decoration", "text-emphasis"],
    ...
    Mp = (e, t) =>
      !Pp(t) &&
      (((e, t) => ((e, t) => vu(e.dom, t).isNone())(e, t) || ((e, t) => bu(e.dom, t).isNone())(e, t) || Cp(e, t) || wp(e, t) || Np(e, t) || _p(e, t))(
        e,
        t
      ) ||
        Bp(e, t) ||
        ...
        () =>
          ((e, t, n, o) => {
            ...
            return Ih(n, o).bind((o) =>
              bs(o)
                ? Uh(e, o)
                : ((e, t, n, o, r) => gu(n, e.getBody(), r).bind((e) => Ih(t, yn(e.getNode())).bind((e) => (En(e, o) ? I.none() : I.some(E)))))(
                    e,
                    n,
                    t,
                    o,
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  ;(a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                    c && u && (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), km(a) && Yb(e, a, 0, c))
                }
                return o
              })(e, s, i, o, o, 0, a, n)
            },
                ...
                ? (km(s) || (wm(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    ;(xb(e, s, n, o) && pv(e, t, o, r)) ||
                      (t.merge_with_parents && s && e.dom.getParent(s, (s) => !!xb(e, s, n, o) && (pv(e, t, o, r), !0)))
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
        ...
        Le = function (e, t, n) {
          ...
          if (G && !W[t] && dy(L, t));
            ...
            if (
              !(
                (Me(e) &&
                  ((V.tagNameCheck instanceof RegExp && dy(V.tagNameCheck, e)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                ...
                ("is" === t &&
                  ...
                  ((V.tagNameCheck instanceof RegExp && dy(V.tagNameCheck, n)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(n))))
              )
            )
              return !1
          } else if (ue[t]);
      ...
      return (
        (n.sanitize = function (e, r) {
          ...
          if ((J || xe(r), (n.removed = []), "string" == typeof e && (se = !1), se)) {
            ...
            (1 === (l = (a = Oe("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === l.nodeName) || "HTML" === l.nodeName
              ? (a = l)
              : a.appendChild(l)
          else {
              ...
              x &&
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      const t = i.next
                      g(o, i) ? (l || ((l = new Fg(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i)) : (d(l), (l = null)),
                        (i = t)
                    }
                    d(l)
                  }
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            ...
            return (
              ...
              o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), _C(e, r, !0), e.setDirty(!0), e.dispatch("Undo", { level: r })),
              r
            )
          })(e, t, n, o),
        redo: (t, n) =>
          ((e, t, n) => {
            let o
            return t.get() < n.length - 1 && (t.set(t.get() + 1), (o = n[t.get()]), _C(e, o, !1), e.setDirty(!0), e.dispatch("Redo", { level: o })), o
          })(e, t, n),
        clear: (t, n) =>
          ((e, t, n) => {
  ...
  const Nw = (e, t) => {
    ...
    Rw = (e) => () => e.notificationManager.open({ text: e.translate("Image uploading..."), type: "info", timeout: -1, progressBar: !0 }),
    ...
    zw = (e, t) => {
      ...
      return (
        Lw(o.split(" "), (e) => {
          ...
          if (
            !(
              ("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = s(e)), "#ffffff" === Wu(t).toLowerCase())) ||
                      ...
                      Yw(e, n).map((n) =>
                        ((e, t, n) =>
                          rr(n.position.getNode()) && !bs(n.block)
                            ? hu(!1, n.block.dom)
                                .bind((o) => (o.isEqual(n.position) ? fu(t, e, o).bind((t) => Yw(e, t)) : I.some(n)))
                                .getOr(n)
                            : n)(e, t, n)
                      )
                    )
    ...
    Qx = (e, t) =>
      e ? t.fold(S(I.some, Lx.start), I.none, S(I.some, Lx.after), I.none) : t.fold(I.none, S(I.some, Lx.before), I.none, S(I.some, Lx.end)),
    Jx = (e, t, n) => {
      const o = e ? 1 : -1
  ...
  const xk = (e, t, n, o, r, s) => {
    ...
    Wk = (e, t, n) => {
      if (e.selection.isCollapsed() && dd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n ? e.fold(N(I.some(Gx(e))), I.none, N(I.some(Kx(e))), I.none) : e.fold(I.none, N(I.some(Kx(e))), I.none, N(I.some(Gx(e))))
            )
            .map(Vk(e, t))
            .getOrThunk(() => {
              const i = gu(n, r, o),
    ...
    zE = (e, t) => ue(((e, t) => te(((e) => V(e, (e) => ({ ...ME, ...e })))(e), (e) => (IE(e, t) ? [e] : [])))(e, t), (e) => e.action()),
    jE = (e, t) => {
      const n = t ? Jc.Forwards : Jc.Backwards,
        o = e.selection.getRng()
    ...
    uS = (e, t) => {
      ...
      return ((e, t) =>
        ((e, t, n = L) => (n(t) ? I.none() : H(e, Ht(t)) ? I.some(t) : Zn(t, e.join(","), (e) => xn(e, "table") || n(e))))(["td", "th"], e, t))(
        ...
        () =>
          ((e, t, n, o = 0) => {
            ...
            return vS(
              ...
              const s = yS(r)
              return 0 !== s.lastIndexOf(n) || wS(s, n).length < o ? I.none() : I.some({ text: wS(s, n), range: r, trigger: n })
            })
          })(e, t, n, o),
        (t) => {
          const o = e.createRng()
  ...
  const NS = (e, t, n) => (e.stype === _S.Error ? t(e.serror) : n(e.svalue)),
      ...
      extract: (n, o) =>
        xe(o, e).fold(
          ...
          (e) =>
            ((e, t, n, o) =>
              xe(n, o).fold(
                () => ((e, t, n) => BS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + TS(t)))(e, n, o),
    ...
    HS = (e, t, n, o, r) => {
      ...
      switch (e.tag) {
        case "required":
          return ((e, t, n, o) =>
            xe(t, n).fold(() => ((e, t, n) => BS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + TS(n)))(e, n, t), o))(
            t,
            n,
            o,
            s
    ...
    qS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === _S.Error ? { stype: _S.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(
          e,
          t,
          n
        )),
  ...
  const D_ = (e) => {
    ...
    uN = (e, t, n) =>
      Jo(t) ? (e ? (1 === n && t.data.charAt(n - 1) === Mr ? 0 : n) : n === t.data.length - 1 && t.data.charAt(n) === Mr ? t.data.length : n) : n,
    mN = {
      insert: (e, t) => {
        let n,
          o,
        ...
        $o(n) &&
          n.hasChildNodes() &&
          !p &&
          ((a = o > n.childNodes.length - 1), (n = n.childNodes[Math.min(o, n.childNodes.length - 1)] || n), (o = a && Jo(n) ? n.data.length : 0))
        const E = Z_(i, n)
        if (
          !E ||
          ((e, t) => {
        ...
        if (p)
          ...
          const t = ((e) => {
            const t = e.cloneRange()
            return (
              t.setStart(e.startContainer, uN(!0, e.startContainer, e.startOffset)), t.setEnd(e.endContainer, uN(!1, e.endContainer, e.endOffset)), t
            )
          })(d).cloneRange()
          t.setEndAfter(S)
              ...
              t.isDefaultPrevented() ||
                ((e, t) => {
                  zE(
                    ...
                    t.preventDefault(), K_(e, "insertText", { data: " " }).isDefaultPrevented() || (n(), W_(e, "insertText", { data: " " }))
                  })
                })(e, t)
            })
          })(e),
  ...
  const dA = (e, t) => Math.abs(e.left - t),
              ...
              !((e, t, n) => {
                const o = yn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return { x: n - (e ? r.left + t.dom.clientLeft + fw(t) : 0), y: o - (e ? r.top + t.dom.clientTop + mw(t) : 0) }
                  })(e.inline, r, t, n)
                return ((e, t, n) => {
                  const o = cw(e),
                    r = uw(e)
      ...
      return hS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (XA(a)) return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d })
        {
          ...
          return m.map((e) => {
            ...
            return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: mS(e.startContainer, e.startOffset) }
          })
        }
      })
    },
          ...
          const s = Math.max(0, n.startOffset),
            ...
            l = ((e, t, n, o) => {
              ...
              return ((e, t) => {
                ...
                .map((e) => (Dt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: IA(s, s.getRoot(), t, 0, t, 0, true) }]))
                .getOr([])
            })(e, o, a)
          return (
    ...
    gO = (e) => {
      ...
      ;(o.disabled = !0),
        ...
        !e.readonly &&
          e.hasEditableRoot() &&
          (e.inline && "static" === aO.getStyle(o, "position", !0) && (o.style.position = "relative"), (o.contentEditable = "true")),
        (o.disabled = !1),
        (e.editorUpload = Ow(e)),
        (e.schema = ca(cO(e))),
        (e.dom = Oa(n, {
        ...
        e.inline
          ...
          : ((e, t) => {
              ;((e, t) => {
                ...
                t.editorContainer && ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = hO.isHidden(t.editorContainer))),
  ...
  class OT {
      ...
      ;(this.options = ((e, t) => {
        ...
        ((e) => {
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            t("text_patterns", {
              processor: (e) =>
                k(e, f) || !1 === e ? { value: ml(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: "Must be an array of objects or false." },
              default: [
    ...
    render() {
      ;((e) => {
        ...
        s &&
          ((e.formElement = s),
          hd(e) && !Qo(e.getElement()) && (wO.insertAfter(wO.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
    ...
    resetContent(e) {
      void 0 === e ? WC(this, this.startContent, { format: "raw" }) : WC(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
    }
    isDirty() {
    ...
    destroy(e) {
      ;((e, t) => {
        ...
        e.destroyed ||
          (t || e.removed
            ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), sw(n), sw(o)),
              ((e) => {
              ...
              ((e) =>
                At.browser.isIE() || At.browser.isEdge()
                  ? (xw(
                    ...
                    [])
                  : UT
                  ? (xw("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), [])
                  : m(e.selector)
