  ...
  const t = (e) => (t) =>
      ((e) => {
        ...
        return null === e
          ...
          ? "array"
          : "object" === t &&
            ((a = n = e), (r = String).prototype.isPrototypeOf(a) || (null === (s = n.constructor) || void 0 === s ? void 0 : s.name) === r.name)
          ? "string"
          : t
        var a, n, r, s
      })(t) === e,
  ...
  const c = (e) => (t) => t.options.get(e),
    ...
    M = (e, t, a = new Date()) => {
      ...
      return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace("%D", "%m/%d/%Y")).replace(
        ...
        "%d",
        _(a.getDate(), 2)
      )).replace("%H", "" + _(a.getHours(), 2))).replace("%M", "" + _(a.getMinutes(), 2))).replace("%S", "" + _(a.getSeconds(), 2))).replace(
        "%I",
        "" + (((a.getHours() + 11) % 12) + 1)
      )).replace("%p", a.getHours() < 12 ? "AM" : "PM")).replace("%B", "" + e.translate(l[a.getMonth()]))).replace(
        "%b",
        "" + e.translate(s[a.getMonth()])
      )).replace("%A", "" + e.translate(r[a.getDay()]))).replace("%a", "" + e.translate(n[a.getDay()]))).replace("%%", "%")
    }
  class T {
    constructor(e, t) {
