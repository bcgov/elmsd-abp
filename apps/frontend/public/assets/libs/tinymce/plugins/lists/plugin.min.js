...
!(function () {
        ...
        .fold(
          () => {
            ...
            const r = ((e, t, n) =>
              H(e)
                .filter(_)
                .map((o) => ({ depth: t, dirty: !1, isSelected: n, content: at(e), itemAttributes: ie(e), listAttributes: ie(o), listType: $(o) })))(
              o,
              e,
              n.get()
            )
  ...
  const St = de.DOM,
      ...
      const t = {},
        n = (n) => {
          ...
          if (ge(o)) {
            ...
            o.hasChildNodes()
              ? ((r = Math.min(r, o.childNodes.length - 1)), n ? o.insertBefore(e, o.childNodes[r]) : St.insertAfter(e, o.childNodes[r]))
              : o.appendChild(e),
              (o = e),
              (r = 0)
          }
    ...
    xt = (e, t, n, o) => {
      ...
      const i = (t, n) => {
        ...
        let l
        for (; (l = s[i]()); )
          if (!Oe(e, l) && !Ct(l.textContent) && 0 !== (null === (r = l.textContent) || void 0 === r ? void 0 : r.length)) return g.some(l)
        return g.none()
      }
      if (n && pe(r))
                ...
                if (s && n.isEmpty(s)) {
                  ...
                  if (i) {
                    const l = (e) => v(["td", "th", "caption"], $(e)),
                      a = (e) => e.dom === r
                    return (
                      !!((e, t, n = u) => I(e, t, n).getOr(e.isNone() && t.isNone()))(W(R(i), l, a), W(R(o.startContainer), l, a), U) &&
                      (e.undoManager.transact(() => {
        ...
        ;((e) => {
          ...
          ye(t) &&
            ...
            e.windowManager.open({
              ...
              initialData: { start: Qt({ start: e.dom.getAttrib(t, "start", "1"), listStyleType: g.from(e.dom.getStyle(t, "list-style-type")) }) },
              buttons: [
  ...
  e.add(
    ...
    (e) => (
                ...
                r(n) &&
                  ((e, t) => {
                    ...
                    null === n ||
                      Ge(e, n) ||
                      e.undoManager.transact(() => {
                        r(t.styles) && e.dom.setStyles(n, t.styles), r(t.attrs) && re(t.attrs, (t, o) => e.dom.setAttrib(n, o, t))
                      })
                  })(e, n)
              }),
      ...
      ((e) => {
        const t = { text: "List properties...", icon: "ordered-list", onAction: () => e.execCommand("mceListProps"), onSetup: en(e, "OL") }
