  ...
  const M = (e, t = {}) => A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
    ...
    re = (e) => {
      const t = ((e) => {
        ...
        s = { title: "General", name: "general", items: c([[{ name: "source", type: "urlinput", filetype: "media", label: "Source" }], a]) },
        i = []
      ...
      const m = { type: "tabpanel", tabs: l },
        u = e.windowManager.open({
          ...
          onSubmit: (t) => {
            ...
            ;((e, t, r) => {
              var o, a
              ;(t.embed = te(e, t) && k(r) ? G(r, { ...t, embed: "" }) : P(null !== (o = t.embed) && void 0 !== o ? o : "", t, !1, r.schema)),
        ...
        e.on("click keyup touchend", () => {
          ...
          e.on("ObjectResized", (t) => {
            ...
            if (r.getAttribute("data-mce-object")) {
              ...
              o &&
                ((o = unescape(o)), r.setAttribute("data-mce-html", escape(P(o, { width: String(t.width), height: String(t.height) }, !1, e.schema))))
            }
          })
      })(e),
      ((e) => ({
