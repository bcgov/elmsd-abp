    ...
    W = (e, t, n, o, r) => {
      ...
      if (
        ((e, t) =>
          ...
          R(e, t) ||
          M(e, t) ||
          ((e, t) => "true" === e.getContentEditable(t) && t.parentNode && "false" === e.getContentEditableParent(t.parentNode))(e, t))(e, n)
      )
        return
        ...
        return ((e, t) => {
          ...
          (r = (e, n) => {
            const o = B(n),
              ...
              s = r + o.length,
              a = v(t, (e, t) =>
                e.start < s && e.finish > r ? [{ element: n, start: Math.max(r, e.start) - r, finish: Math.min(s, e.finish) - r, matchId: t }] : []
              )
